...
INSERT INTO groundhogs (id, slug, shortname, name, city, region, country, coordinates, source, contact, currentPrediction, isGroundhog, type, active, successor, description, image) VALUES (19, 'mojave-max', 'Max', 'Mojave Max', 'Las Vegas', 'Nevada', 'USA', '36.1693608,-115.1906908', 'https://www.mojavemax.com/learn/meet-mojave-max/index.html', '', 'https://lasvegassun.com/news/2026/may/10/mojave-max-emerges-setting-record-for-latest-ever/', 0, 'Desert tortoise', '1','', 'Mojave Max is a desert tortoise prognosticator who heralds spring’s arrival in Nevada. Groundhogs, who are famously not very accurate at making bets, avoid Las Vegas due to the heat and amount of money they would lose. Max, however, is right at home in the Nevada desert. Every year, Max enters a burrow to ‘brumate’ (hibernation for reptiles) throughout winter and emerges in the spring. Groundhog Day marks the start of “Mojave Max Watch,” a contest for elementary school students to guess the tortoise’s emergence date. Max’s emergence is “the preeminent indicator of spring-like weather in Southern Nevada and the west coast.” GROUNDHOG-DAY.com interprets Max’s predictions based on if he emerges on March 16 or later, which is 6 weeks after Groundhog Day.', 'https://groundhog-day.com/images/ghogs/mojave-max.jpeg');
...
INSERT INTO predictions (slug, year, shadow, details) VALUES ('mojave-max', 2025, 1, '2025-05-08, 2:09 pm, Thursday');
INSERT INTO predictions (slug, year, shadow, details) VALUES ('mojave-max', 2026, 1, '2025-05-20, 12:50 p.m, Wednesday, Latest emergence');
