...
INSERT INTO groundhogs (id, shortname, name, city, region, country, source, currentPrediction, isGroundhog, type, description) VALUES (4, 'Chuck', 'Staten Island Chuck', 'New York City', 'New York', 'USA', 'https://en.wikipedia.org/wiki/Staten_Island_Chuck#Past_predictions', 'http://www.statenislandzoo.org/groundhog-day/', 1, 'Groundhog', 'Staten Island Chuck — also known as Charles G. Hogg — is a groundhog living at the Staten Island Zoo in New York City. He is one of the most accurate groundhogs, with an 85\% accuracy rate. Chuck bit the hand of Mayor Micheal Bloomberg and was subsequently the victim of an alleged manslaughter by succeeding Mayor Bill De Blasio.');
