...
INSERT INTO groundhogs (id, slug, shortname, name, city, region, country, source, contact, currentPrediction, isGroundhog, type, active, description) VALUES (9, 'gertie-the-groundhog', 'Gertie', 'Gertie the Groundhog', 'Hanna City', 'Illinois', 'USA', 'https://www.facebook.com/watch/wildlifeprairiepark/', '', 'https://www.hoiabc.com/2022/02/02/gertie-groundhog-predicts-early-spring/', 1, 'Groundhog', '1', 'Gertie the Groundhog is a celebrated meteorologist from Wildlife Prairie State Park, Illinois. Since 1993, Gertie has been predicting the weather on February 2nd from her wildlife chalet, inspiring local musician Barry Cloyd to write the original, hit song “Wake-Up Gertie.”');
