...
INSERT INTO groundhogs (id, slug, shortname, name, city, region, country, coordinates, source, contact, currentPrediction, isGroundhog, type, active, successor, description, image) VALUES (49, 'snerd', 'Snerd', 'Snerd', 'Garner', 'North Carolina', 'USA', '35.6800912,-78.6279155', 'https://www.facebook.com/GarnerParksRecreationAndCulturalResources', '', 'https://www.facebook.com/GarnerParksRecreationAndCulturalResources/posts/pfbid02PLPuFs3teWavJKjnTknojBigEZU4BR9ZDSNorDyyyuTUP1Dkwv4ZufpwFtXBmmnAl', 1, 'Groundhog', '1','', 'Snerd is a groundhog prognosticator who gives an annual prediction from White Deer Park, in Garner, North Carolina. North Carolina’s roster of true groundhog prognosticators has dwindled to just Snerd — Garner’s official prognosticator since 2015 — but he is in good company with Pisgah Piper, a white squirrel, and Sylvia the armadillo. According to Snerd’s translator from wildlife rehabilitation organization CLAWS, Snerd spends weeks conferring with Mother Nature, the Farmer’s Almanac, and the Weather Channel to get precise information before making his yearly prediction.', 'https://groundhog-day.com/images/ghogs/snerd.jpeg');
...
INSERT INTO predictions (slug, year, shadow, details) VALUES ('snerd', 2026, null, '');
