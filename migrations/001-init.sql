...
INSERT INTO groundhogs (id, slug, shortname, name, city, region, country, source, currentPrediction, isGroundhog, type, active, description) VALUES (8, 'lander-lil', 'Lil', 'Lander Lil', 'Lander', 'Wyoming', 'USA', 'https://www.facebook.com/BLMWyoming', 'https://cowboystatedaily.com/2022/02/02/bill-sniffin-lander-lil-predicts-early-spring-in-wyoming-we-hope/', 0, 'Statue of a prairie dog', '1', 'For the past 38 years, Lander Lil, a bronze statue of a prairie dog, has been predicting the future of winter weather for Wyoming. There really was a real Lander Lil before the installation of a larger-than-life bronze statue, which stands lookout from her perch on the grounds of the local Post Office.');
...
INSERT INTO groundhogs (id, slug, shortname, name, city, region, country, source, currentPrediction, isGroundhog, type, active, description) VALUES (11, 'beardsley-bart', 'Bart', 'Beardsley Bart', 'Bridgeport', 'Connecticut', 'USA', 'https://twitter.com/beardsleybart', 'https://www.beardsleyzoo.org/press/beardsley-bart-connecticuts-prognosticating-prairie-dog-makes-his-groundhog-day-weather-prediction', 0, 'Prairie dog', '1', 'Beardsley Bart is the principal prognosticating prairie dog from Connecticut’s Beardsley Zoo. His official title is Senior Spring Arrival Specialist. Every year, Beardsley Bart says that spring is coming eventually, and he has always been 100 percent correct.');
