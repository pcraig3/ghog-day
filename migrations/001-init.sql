...
INSERT INTO groundhogs (id, slug, shortname, name, city, region, country, coordinates, source, contact, currentPrediction, isGroundhog, type, active, successor, description, image) VALUES (51, 'snowy-the-prairie-dog', 'Snowy', 'Snowy the Prairie Dog', 'Pend Oreille County', 'Washington', 'USA', '48.5224835,-117.8912722', 'http://www.climatehawk.org/groundhog.html', '', 'http://www.climatehawk.org/groundhog.html', 0, 'Prairie dog', '0','', 'Snowy the Prairie Dog makes an annual weather prediction from Pend Oreille Country, Washington. Snowy and Flurries are a tag-team of prognosticating prairie dogs with their very own website and an impressive accuracy rating. Bob Lutz, traffic broadcaster for 920 News Now, maintains their list of historical predictions as well as an “Accuracy Score” for each year: a level of accountability that few other prognosticators can meet.', 'https://groundhog-day.com/images/ghogs/snowy-the-prairie-dog.jpeg');
