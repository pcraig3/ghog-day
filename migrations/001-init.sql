...
INSERT INTO groundhogs (id, slug, shortname, name, city, region, country, source, currentPrediction, isGroundhog, type, active, description) VALUES (7, 'general-beauregard-lee', 'Beau', 'General Beauregard Lee', 'Jackson', 'Georgia', 'USA', 'https://twitter.com/genbeaulee', 'https://twitter.com/genbeaulee/status/1488854634626174979', 1, 'Groundhog', '1', 'General Beauregard Lee is Georgia’s Official Weather Prognosticator, considered the principal prognosticator for the southern USA. General Beau lives comfortably in his groundhog-sized mansion known as Weathering Heights, where he enjoys naps, digging tunnels, and hashbrowns.');
...
INSERT INTO groundhogs (id, slug, shortname, name, city, region, country, source, currentPrediction, isGroundhog, type, active, description) VALUES (23, 'ms-g', 'Ms. G', 'Ms. G', 'Lincoln', 'Massachusetts', 'USA', 'https://www.facebook.com/MassAudubonDrumlinFarm', 'https://www.masslive.com/weather/2022/02/massachusetts-state-groundhog-ms-g-disagrees-with-punxsutawney-phil-says-spring-has-come.html', 1, 'Groundhog', '1', 'Ms. G has been the official state groundhog of Massachusetts since 2014, after a successful nomination effort from Hunnewell Elementary School students. Ms. G has health issues that prevent her from living alone in the wild, but she fills her day with visiting schools and community groups in her role as an ambassador of the natural world.');
